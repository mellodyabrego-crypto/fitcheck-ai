...
const _content = [
  ...
  _ContentItem(
    ...
    url:
        'https://www.youtube.com/results?search_query=soft+glam+makeup+tutorial',
    duration: '18:24',
    category: 'Makeup',
    views: '2.4M views',
  ),
  ...
  _ContentItem(
    ...
    url:
        'https://www.youtube.com/results?search_query=paris+fashion+week+highlights',
    duration: '30:44',
  ...
  _ContentItem(
    ...
    url:
        'https://www.youtube.com/results?search_query=quick+hairstyles+tutorial',
    duration: '11:33',
    category: 'Hair',
    views: '2.9M views',
  ),
  _ContentItem(
    ...
    channel: 'Brad Mondo',
    thumbnail:
        'https://images.unsplash.com/photo-1562887245-d13bde0a7e7b?w=800&q=80',
  ...
  _ContentItem(
    ...
    url:
        'https://www.youtube.com/results?search_query=sleek+bun+hairstyle+tutorial',
    duration: '6:44',
    category: 'Hair',
    views: '1.5M views',
  ),
  ...
  _ContentItem(
    ...
    url:
        'https://www.youtube.com/results?search_query=outfit+styling+rules+tips',
    duration: '14:20',
  ...
  _ContentItem(
    ...
    url:
        'https://www.youtube.com/results?search_query=color+combination+outfits',
    duration: '11:53',
    category: 'Clothing Tips',
    views: '2.6M views',
  ),
  ...
  _ContentItem(
    ...
    url:
        'https://www.youtube.com/results?search_query=spring+2025+fashion+trends',
    duration: '18:55',
    category: 'Trends',
    views: '9.8M views',
  ),
  _ContentItem(
    ...
    url:
        'https://www.youtube.com/results?search_query=quiet+luxury+fashion+aesthetic',
    duration: '12:30',
    category: 'Trends',
    views: '6.2M views',
  ),
  ...
  _ContentItem(
    ...
    thumbnail:
        'https://images.unsplash.com/photo-1469334031218-e382a71b716b?w=800&q=80',
    url:
        'https://www.harpersbazaar.com/fashion/trends/a43000/how-to-dress-for-your-body-type/',
    duration: 'Article',
    category: 'Styling',
    views: 'HarpersBazaar.com',
  ),
  _ContentItem(
  ...
  _ContentItem(
    ...
    url:
        'https://www.youtube.com/results?search_query=skincare+mistakes+dermatologist',
    duration: '14:22',
    category: 'Skincare',
    views: '5.7M views',
  ),
  _ContentItem(
    ...
    url:
        'https://www.youtube.com/results?search_query=best+sunscreen+guide+skincare',
    duration: '9:15',
    category: 'Skincare',
    views: '3.1M views',
  ),
  ...
  _ContentItem(
    ...
    url:
        'https://www.youtube.com/results?search_query=gym+to+street+outfit+ideas',
    duration: '13:50',
    category: 'Athleisure',
    views: '2.2M views',
  ),
  ...
  _ContentItem(
    ...
    url:
        'https://www.youtube.com/results?search_query=2025+shoe+trends+fashion',
    duration: '15:40',
    category: 'Shoes',
    views: '4.8M views',
  ),
  ...
  _ContentItem(
    ...
    url:
        'https://www.youtube.com/results?search_query=how+to+style+statement+heels',
    duration: '11:22',
    category: 'Shoes',
    views: '1.9M views',
  ),
  ...
  _ContentItem(
    ...
    thumbnail:
        'https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?w=800&q=80',
    url:
        'https://www.youtube.com/results?search_query=layered+necklace+styling',
    duration: '7:32',
    category: 'Jewelry',
    views: '2.1M views',
  ),
  ...
  _ContentItem(
    ...
    url:
        'https://www.youtube.com/results?search_query=chunky+gold+jewelry+2025',
    duration: '8:40',
    category: 'Jewelry',
    views: '2.7M views',
  ),
  ...
  _ContentItem(
    ...
    thumbnail:
        'https://images.unsplash.com/photo-1558769132-cb1aea458c5e?w=800&q=80',
    url:
        'https://www.youtube.com/results?search_query=how+to+build+an+outfit+quick',
    duration: '7:18',
    category: 'Styling',
    views: '1.9M views',
  ),
  _ContentItem(
    ...
    thumbnail:
        'https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?w=800&q=80',
    url:
        'https://www.harpersbazaar.com/fashion/street-style/monochrome-outfits',
    duration: 'Article',
    category: 'Styling',
    views: 'HarpersBazaar.com',
  ),
